...
// Memoized: re-parsing ReactMarkdown for every bubble on every timeline
// render is the single most expensive thing in the chat view, and a bubble's
// props only change while it is the live streaming message.
export const MessageBubble = memo(function MessageBubble({ message, isLive = false }: Props) {
